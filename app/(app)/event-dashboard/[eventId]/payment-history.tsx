...
export default function PaymentHistory() {
    ...
    const getStatusColor = (status) => {
        switch (status) {
            case 'Success':
                return colors.button; // success (green)
            case 'Pending':
                return colors.text; // or a custom info color if you add one
            case 'Rejected':
                return colors.cancelButton; // error (red)
            default:
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            >
                ...
                {/* card #2 ---------------------------------------------------- */}
                <Card style={[styles.summaryCard, { backgroundColor: colors.dropdownBackground }]}>
                    <Card.Content>
                ...
                <Card style={[styles.summaryCard, { backgroundColor: colors.card }]}>
                    <Card.Content>
                        ...
                        <View style={styles.withdrawalRow}>
                            ...
                            <View style={styles.iconRow}>
                                <IconButton icon="check-circle" iconColor={colors.button} size={20} />
                                <IconButton icon="delete" iconColor={colors.cancelButton} size={20} />
                            </View>
                        </View>
                    </Card.Content>
                </Card>
